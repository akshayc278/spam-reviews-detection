...
public class ValueExtractor extends Configured implements Tool {
	    ...
	    public static class KeyMapper4 extends Mapper<Text, Text, Text, Text> {
           ...
           boolean b = true;
           double totalScore = 0;
           private static String pathToSWN = "/home/akshay/Desktop/SentiWordNet_3.0.0.txt";
	    ...
	    public static class KeyReducer2 extends Reducer<Text,Text,Text,Text> {
	    	...
	    	public static double calibrate (double n) {
	    			...
	    			if(n>=-1 && n<-0.3)
	    				generated = (((n - (-1)) * (25 - 1)) / (-0.31 - (-1))) + 1;
	    			
	    			if(n>=-0.3 && n<=0.0)
	    				generated = (((n - (-0.3)) * (50 - 26)) / (-0.001 - (-0.3))) + 26;
	    			
	    			if(n>=0.0 && n<=3.0)
	    				generated = (((n - (0.001)) * (75 - 51)) / (0.3 - (0.001))) + 51;
	    			
	    			if(n>0.3 && n<=1.0)
	    				generated = (((n - (0.31)) * (100 - 76)) / (1 - (0.31))) + 76;
